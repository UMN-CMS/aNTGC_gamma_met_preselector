...
private:
	...
	Int_t nBquarksInJet_;
	UChar_t isGenBtagged_;

	Float_t genBBarMass_;
	...
	var_p_genBtag{p_genBtag, 0., 16., 16, "Gen b tagging"},
	var_AK8PuppiJet_DDBDTags_bbcsLight_{AK8PuppiJet_DDBDTags_bbcsLight_, 0., 1., 100, "DBBD bb vs L"},
	var_AK8PuppiJet_CSV_{AK8PuppiJet_CSV_, 0., 1., 100, "CSV_{v2}"},
	var_AK8PuppiJet_DDCvBTags_Hbb_{AK8PuppiJet_DDCvBTags_Hbb_, 0., 1., 100, "DDC vs B : bb"},
	var_genBBarMass_{genBBarMass_, 40., 140., 100, "Mass gen(bbar)", "GeV"};
	...
	std::vector<histogram_template> boostedJetG_1d_Histograms = {
		...
		{var_AK8PuppiJet_DDBDTags_bbcsLight_},
		{var_AK8PuppiJet_CSV_},
		{var_AK8PuppiJet_DDCvBTags_Hbb_}
	...
	std::vector<twoDhistogram_template> boostedJetG_2d_Histograms ={
		...
		{var_genBBarMass_, var_AK8PuppiJet_DDBDTags_bbcsLight_},
		{var_p_genBtag, var_AK8PuppiJet_DDBDTags_bbcsLight_},
		{var_p_genBtag, var_AK8PuppiJet_CSV_},
		{var_p_genBtag, var_AK8PuppiJet_DDCvBTags_Hbb_}
